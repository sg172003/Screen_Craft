    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-900 text-base sm:text-lg">ScreenCraft</span>
          </div>
      ...
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-xl text-gray-600 max-w-xl mx-auto mb-6 sm:mb-8 px-4 sm:px-0">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6 mt-6 sm:mt-8 text-xs sm:text-sm text-gray-500">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
            ...
            <div className="space-y-3 sm:space-y-4">
              <p className="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Raw Screenshot</p>
              <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden border border-gray-200">
                <div className="bg-gray-100 p-3 sm:p-4">
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm">
                    <div className="h-3 sm:h-4 w-24 sm:w-32 bg-gray-200 rounded mb-2 sm:mb-3" />
                    <div className="h-2.5 sm:h-3 w-full bg-gray-100 rounded mb-1.5 sm:mb-2" />
                    <div className="h-2.5 sm:h-3 w-4/5 bg-gray-100 rounded mb-1.5 sm:mb-2" />
                    <div className="h-2.5 sm:h-3 w-3/5 bg-gray-100 rounded" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              >
                <div 
                  className="bg-white rounded-lg sm:rounded-xl shadow-xl overflow-hidden"
                  style={{
                    boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
                  }}
                >
                  <div className="bg-gray-50 px-2 sm:px-3 py-1.5 sm:py-2 flex items-center gap-1.5 sm:gap-2 border-b border-gray-100">
                    ...
                    <div className="flex-1 mx-2 sm:mx-3">
                      <div className="bg-white rounded-md h-4 sm:h-5 w-full border border-gray-200" />
                    </div>
                  </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-8 sm:gap-6">
            ...
            <div className="relative text-center">
              ...
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 text-xs font-semibold mb-3">
                1
              </span>
            ...
            <div className="relative text-center">
              ...
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-purple-100 text-purple-600 text-xs font-semibold mb-3">
                2
              </span>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">
                Customize Style
            ...
            <div className="text-center">
              ...
              <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-pink-100 text-pink-600 text-xs font-semibold mb-3">
                3
              </span>
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">
                Download & Share
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center p-4 sm:p-6 bg-white rounded-xl shadow-sm">
              <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 bg-blue-50 rounded-xl flex items-center justify-center">
                <Code2 className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1.5 sm:mb-2">Developers</h3>
            ...
            <div className="text-center p-4 sm:p-6 bg-white rounded-xl shadow-sm">
              <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 bg-purple-50 rounded-xl flex items-center justify-center">
                <Palette className="w-5 h-5 sm:w-6 sm:h-6 text-purple-500" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1.5 sm:mb-2">Designers</h3>
              <p className="text-gray-600 text-sm">
            ...
            <div className="text-center p-4 sm:p-6 bg-white rounded-xl shadow-sm">
              <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4 bg-pink-50 rounded-xl flex items-center justify-center">
                <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 text-pink-500" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1.5 sm:mb-2">Product Builders</h3>
              <p className="text-gray-600 text-sm">
      ...
      <footer className="py-6 sm:py-8 px-4 sm:px-6 border-t border-gray-100">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-gray-700">ScreenCraft</span>
          </div>
          <p className="text-xs sm:text-sm text-gray-500">
            © 2025 ScreenCraft. Free and open.
          </p>
        </div>
      </footer>
    </div>
